...
namespace MaterialUI
{
    ...
    public class TabView : UIBehaviour
    {
        ...
        [System.Serializable] // Added by Pavan Jakhu
        public class PageChangedEvent : UnityEngine.Events.UnityEvent<int> { } // Added by Pavan Jakhu
        [SerializeField] // Added by Pavan Jakhu
        private PageChangedEvent m_OnPageChanged; // Added by Pavan Jakhu
        public PageChangedEvent onPageChanged // Added by Pavan Jakhu
        { // Added by Pavan Jakhu
            get { return m_OnPageChanged; } // Added by Pavan Jakhu
            set { m_OnPageChanged = value; } // Added by Pavan Jakhu
        } // Added by Pavan Jakhu
        ...
        public void InitializeTabs()
        {
            ...
            for (int i = 0; i < m_Pages.Length; i++)
            {
                ...
                m_Indicator.SetAsLastSibling(); // Added by Pavan Jakhu
